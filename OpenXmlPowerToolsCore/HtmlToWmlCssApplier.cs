...
using OpenXmlPowerToolsCore;
using OpenXmlPowerToolsCore.HtmlToWml;
using OpenXmlPowerToolsCore.HtmlToWml.CSS;
...
namespace OpenXmlPowerToolsCore.HtmlToWml
{
    class CssApplier
    {
        private static List<PropertyInfo> PropertyInfoList = new List<PropertyInfo>()
        {
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "black", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = (element, assignedValue, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = GetWmlColorFromExpression(assignedValue), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
            },
            ...
            new PropertyInfo
            {
                ...
                Inherits = true,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "ltr", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                Inherits = true,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "normal", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
            ...
            new PropertyInfo
            {
                ...
                Inherits = true,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "visible", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "disc", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "none", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                Inherits = true,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = settings.MinorLatinFont, Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
            ...
            new PropertyInfo
            {
                ...
                Inherits = true,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = ((double)settings.DefaultFontSize).ToString(CultureInfo.InvariantCulture), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, Unit = CssUnit.PT } } },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "0", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } },
                ComputedValue = (element, assignedValue, settings) =>
                {
                    CssExpression valueForPercentage = null;
                    if (element.Parent != null)
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "left", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, } } },  // todo should be based on the direction property
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "top", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "separate", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, } } },
                ComputedValue = null,
            },
                ...
                InitialValue = (element, settings) => 
                    {
                        if (settings.DefaultBlockContentMargin != null)
                        {
                            if (settings.DefaultBlockContentMargin == "auto")
                                return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "auto", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } };
                            else if (settings.DefaultBlockContentMargin.ToLower().EndsWith("pt"))
                            {
                                ...
                                {
                                    return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = d1.ToString(CultureInfo.InvariantCulture), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT } } };
                                }
                            }
                            throw new OpenXmlPowerToolsException("invalid setting");
                        }
                        return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "0", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT } } };
                    },
                ComputedValue = (element, assignedValue, settings) =>
                {
                    CssExpression valueForPercentage = null;
                ...
                ComputedValue = (element, assignedValue, settings) =>
                    {
                        ...
                        if (assignedValueStr == "thin")
                            return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "0.75", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
                        if (assignedValueStr == "medium")
                            return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "3.0", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
                        if (assignedValueStr == "thick")
                            return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "4.5", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
            ...
            new PropertyInfo
            {
                ...
                Inherits = false,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "inline", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                Inherits = false,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "static", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                Inherits = false,
                Includes = (e, settings) => true,
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "transparent", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
                ComputedValue = (element, assignedValue, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = GetWmlColorFromExpression(assignedValue), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String } } },
            },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "auto", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "show", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, } } },
                ComputedValue = null,
            },
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => 
                {
                    if (element.Parent == null)
                    {
                        ...
                        return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = width.ToString(CultureInfo.InvariantCulture), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, Unit = CssUnit.PT, } } };
                    }
                    return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "auto", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, } } };
                },
                ComputedValue = (element, assignedValue, settings) =>
            ...
            new PropertyInfo
            {
                ...
                InitialValue = (element, settings) => new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "baseline", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.String, } } },
    ...
    if (property is inherited (either because it was set to inherit, or because it is an inherited property))
      ...
      return the computed value
            ...
            CssExpression lengthForPercentage)
        {
            ...
            if (value == "thin")
            {
                CssExpression newExpr1 = new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = ".3", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
                return newExpr1;
            }
            if (value == "medium")
            {
                CssExpression newExpr2 = new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "1.20", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
                return newExpr2;
            }
            if (value == "thick")
            {
                CssExpression newExpr3 = new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = "1.80", Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
                return newExpr3;
            }
            ...
            CssExpression newExpr = new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = newPtSize.Value.ToString(CultureInfo.InvariantCulture), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
            return newExpr;
        }
        ...
        private static CssExpression ComputeAbsoluteFontSize(XElement element, CssExpression assignedValue, HtmlToWmlConverterSettings settings)
        {
            ...
            if (FontSizeMap.ContainsKey(value))
                return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = FontSizeMap[value].ToString(CultureInfo.InvariantCulture), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
            ...
            if (value == "larger" || value == "smaller")
            {
                ...
                return new CssExpression { Terms = new List<CssTerm> { new CssTerm { Value = newPtSize2.ToString(CultureInfo.InvariantCulture), Type = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssTermType.Number, Unit = CssUnit.PT, } } };
            }
            double decValue;
            if (!double.TryParse(value, NumberStyles.Float, CultureInfo.InvariantCulture, out decValue))
        ...
        private static bool DoesAttributeMatch(OpenXmlPowerToolsCore.HtmlToWml.CSS.CssAttribute attribute, XElement element)
        {
                ...
                if (p.Name == "background")
                {
                    ...
                    else
                    {
                        ...
                        backgroundPosition = new CssExpression
                        {
                            ...
                            new CssTerm {
                                Value = "0",
                                Unit = OpenXmlPowerToolsCore.HtmlToWml.CSS.CssUnit.Percent,
        ...
        private static void DumpAttribute(StringBuilder sb, int indent, OpenXmlPowerToolsCore.HtmlToWml.CSS.CssAttribute a)
        {
