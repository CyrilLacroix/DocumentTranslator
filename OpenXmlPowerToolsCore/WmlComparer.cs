...
namespace OpenXmlPowerToolsCore
{
...
@"<w:style w:type=""character""
    ...
    <w:rPr>
      <w:vertAlign w:val=""superscript""/>
        ...
        private static List<CorrelatedSequence> Lcs(ComparisonUnit[] cu1, ComparisonUnit[] cu2, WmlComparerSettings settings)
        {
            ...
            CorrelatedSequence cs = new CorrelatedSequence()
            {
                CorrelationStatus = OpenXmlPowerToolsCore.CorrelationStatus.Unknown,
    ...
    public class ComparisonUnitAtom : ComparisonUnit
    {
        ...
        public override string ToString(int indent)
        {
            ...
            if (CorrelationStatus != OpenXmlPowerToolsCore.CorrelationStatus.Nil)
    ...
    internal class ComparisonUnitGroup : ComparisonUnit
    {
        ...
        public ComparisonUnitGroup(IEnumerable<ComparisonUnit> comparisonUnitList, ComparisonUnitGroupType groupType, int level)
        {
            ...
            if (groupType == OpenXmlPowerToolsCore.ComparisonUnitGroupType.Table)
                ancestorName = W.tbl;
            else if (groupType == OpenXmlPowerToolsCore.ComparisonUnitGroupType.Row)
                ancestorName = W.tr;
            else if (groupType == OpenXmlPowerToolsCore.ComparisonUnitGroupType.Cell)
                ancestorName = W.tc;
            else if (groupType == OpenXmlPowerToolsCore.ComparisonUnitGroupType.Paragraph)
                ancestorName = W.p;
            else if (groupType == OpenXmlPowerToolsCore.ComparisonUnitGroupType.Textbox)
    ...
    class CorrelatedSequence
    {
        ...
        public override string ToString()
        {
            ...
            if (CorrelationStatus == OpenXmlPowerToolsCore.CorrelationStatus.Equal)
            {
