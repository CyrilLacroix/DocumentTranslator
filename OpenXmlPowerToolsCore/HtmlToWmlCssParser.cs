...
namespace OpenXmlPowerToolsCore.HtmlToWml.CSS
{
    ...
    public class CssSimpleSelector
    {
        ...
        public override string ToString()
        {
            ...
            if (m_combinator.HasValue)
            {
                ...
                {
                    case OpenXmlPowerToolsCore.HtmlToWml.CSS.CssCombinator.PrecededImmediatelyBy: 
                        sb.Append(" + "); 
                        break;
                    case OpenXmlPowerToolsCore.HtmlToWml.CSS.CssCombinator.ChildOf: 
                        sb.Append(" > "); 
                        break;
                    case OpenXmlPowerToolsCore.HtmlToWml.CSS.CssCombinator.PrecededBy: 
                        sb.Append(" ~ "); 
                        break;
                }
            }
    ...
    public class CssTerm
    {
        ...
        public override string ToString()
        {
            ...
            else
            {
                ...
                if (m_unit.HasValue)
                {
                    if (m_unit.Value == OpenXmlPowerToolsCore.HtmlToWml.CSS.CssUnit.Percent)
                    {
                        sb.Append("%");
                    }
                    else
        ...
        private int GetRGBValue(CssTerm t)
        {
            try
            {
                if (t.Unit.HasValue && t.Unit.Value == OpenXmlPowerToolsCore.HtmlToWml.CSS.CssUnit.Percent)
                {
    ...
    public class Parser
    {
        ...
        void SimpleSelector(out CssSimpleSelector ss)
        {
            ...
            ss.ElementName = "";
            string psd = null;
            OpenXmlPowerToolsCore.HtmlToWml.CSS.CssAttribute atb = null;
        ...
        void Attrib(out OpenXmlPowerToolsCore.HtmlToWml.CSS.CssAttribute atb)
        {
            atb = new OpenXmlPowerToolsCore.HtmlToWml.CSS.CssAttribute();
            atb.Value = "";
            string quote = null;
            string ident = null;
